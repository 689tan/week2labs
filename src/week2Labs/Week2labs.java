...
System.out.println(age >= 16);
	...
	} else if (numberOfCookies % numberOfChildren <= 4) {
...
if ((adjustedTotal > 500) && loyaltyMemberDiscount == .10) {
	
loyaltyMemberStatus = "Gold" ;
} else if ((adjustedTotal > 500) && loyaltyMemberDiscount == .15) {
